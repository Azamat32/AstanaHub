    ...
    <div class="container">
      <div class="sale__body">
        <div class="sale__left">
          <h3>
            <span>Акция!</span> Очень интересное ограниченное предложение.
          </h3>
        </div>
        <div class="sale__right">
          <div class="sale__right_time">
            <p>осталось</p>
            <h4>15:48:38</h4>
          </div>
          <div class="sale__right_button">
            <a href="#!">Перейти</a>
          </div>
        </div>
