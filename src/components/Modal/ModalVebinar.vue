    ...
    <div :class="{ 'modal': true, 'active': active }">
      <div class="modal_inner">
        ...
        <div class="modal_text">
          <h2>{{ item.title }}</h2>
          <p>Мерейлім Айтасова — специалист по разработке программного обеспечения в IBM и основатель Quran.kz. <br> Спикер обсудил такие темы, как:<br> 🔹 Стратегии успешного возвращения к работе после декрета в сфере IT;<br> 🔹 Практические советы и рекомендации для женщин и девушек, желающих продолжить карьеру в IT;<br> 🔹 Возможности для развития и профессионального роста в индустрии технологий;<br> 🔹 Важные навыки и компетенции, необходимые для успешной работы в сфере разработки программного обеспечения.</p>
        </div>
